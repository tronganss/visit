...
echo " $merah INFO! ";
echo file_get_contents("https://pastebin.com/raw/SAB1kcNZ");
echo " \n";
echo "$hijau Contact Me : \n";
echo " Facebook : Pokoknya namanya DiazID \n";
echo " Email : n3utr0n404@yahoo.com \n";
echo " \n \n";
echo " ~~~~~~ AUTO VISITOR BLOG 2018 TODD ~~~~~\n  ";
echo ' Website Mu: ';
